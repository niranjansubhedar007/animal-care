  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#F5EFFF]">
        ...
        >
          <div className="text-white px-4">
            ...
            <p className="text-xl md:text-2xl">
              Your feedback helps us improve and continue our mission <br /> to help animals in need
            </p>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-[#5E4FA2] mb-1">
                  Your Name *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="comment" className="block text-sm font-medium text-[#5E4FA2] mb-1">
                  Your Review *
                </label>
                <textarea
                  id="comment"
        ...
        {/* Reviews Slider */}
        <div className="bg-white rounded-lg shadow-md p-6 mx-4 md:mx-10 mb-10">
          <div className="flex justify-between items-center mb-6">
            ...
            {reviews.length > reviewsPerSlide && (
              ...
              >
                {isAutoPlaying ? (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#5E4FA2]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {reviews.length > 0 ? (
                  ...
                  {Array.from({ length: Math.ceil(reviews.length / reviewsPerSlide) }).map((_, index) => (
                    <button
                      ...
                      className={`h-2 w-2 rounded-full transition-all ${
                        index === currentSlide ? "bg-[#A294F9] w-4" : "bg-[#E5D9F2]"
                      }`}
            ...
            <p className="text-center text-[#5E4FA2]">No reviews yet. Be the first to review!</p>
          )}
        </div>
      </div>
      <Footer/>
