  ...
  const htmlBody = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 20px auto; background: #f9f9f9; border-radius: 8px; padding: 20px; border: 1px solid #ddd;">
      ...
      <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid ${urgencyColors[userData.urgency]};">
        ...
        ${userData.animalImage ? `
        <div style="margin-bottom: 15px;">
          <strong style="color: #5E4FA2;">Animal Photo Submitted:</strong>
        </div>
        <div style="text-align: center; margin: 15px 0;">
          <img src="${userData.animalImage}" alt="Animal in need of rescue" style="max-width: 100%; max-height: 200px; border-radius: 8px; border: 2px solid #CDC1FF;" />
        </div>
        ` : ''}
        ${userData.notes ? `
        <div style="margin-bottom: 15px;">
...
${userData.animalImage ? `Animal Photo: ${userData.animalImage}` : ''}
